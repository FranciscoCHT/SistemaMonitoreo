...
Namespace Migrations
    ...
    Public NotInheritable Partial Class VoltajeADecimal
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(VoltajeADecimal))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201908182319251_VoltajeADecimal"
            End Get
        End Property
